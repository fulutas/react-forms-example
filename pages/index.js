...
import formImage from "../public/login-photo.jpg";
    ...
    >
      ...
      <main className="h-screen items-center flex justify-center">
        <form
          ...
          className="bg-white flex rounded-lg w-full lg:w-1/2 font-latoRegular"
        >
          <div className="flex-1 text-gray-700  p-20">
            ...
            <div className="mt-6 ">
              ...
              <div className="pb-4">
                ...
                <input
                  className="border-2 border-gray-500 p-2 rounded-md w-full lg:w-1/2 focus:border-teal-500 focus:ring-teal-500 "
                  type="text"
                  name="name"
